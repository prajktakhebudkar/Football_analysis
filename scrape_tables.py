...
table_body = soup.find("tbody", class_="league-table__tbody isPL")

# Check if the table body is found
if table_body is None:
    print("Error: Unable to find the standings table. Check the class name or if the page loads dynamically.")
else:
